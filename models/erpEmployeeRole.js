...
const ErpEmployeeRole = dbSeq.define('erp_employee_role', {
  ...
  invite_status: { type: Sequelize.STRING(40), allowNull: false, defaultValue: 'Belum Dikirim' },
  invite_sent_at: { type: Sequelize.DATE, allowNull: true },
  invite_error: { type: Sequelize.STRING(500), allowNull: true },
