...
const PaymentConfirmation = dbSeq.define('payment_confirmation', {
  id: {
...
}, 
{
  ...
  classMethods: {
    associate: function (models) {
      PaymentConfirmation.hasMany(models.PaymentDetail, {foreignKey: 'payment_id', as: 'payment_detail'})//,
      //Payment.hasMany(models.PaymentStatusHistory, {foreignKey: 'payment_id', as: 'payment_status_histories'})
    },
  },
});

PaymentConfirmation.hasMany(PaymentDetail, {foreignKey: 'payment_id', as: 'payment_detail'});
// Payment.hasMany(PaymentStatusHistory, {foreignKey: 'payment_id', as: 'payment_status_histories'});

PaymentDetail.belongsTo(PaymentConfirmation);
