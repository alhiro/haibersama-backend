...
// const ErpApproval = require('./erpApproval');
// ErpApproval.sequelize.sync({ alter: true })
//     .then(() => {
//         console.log(`Table erp approval updated!`)
//     })

// const ErpAuditLog = require('./erpAuditLog');
// ErpAuditLog.sequelize.sync({ alter: true })
//     .then(() => {
