...
partnerProductRouter.get("/getall", headerAuth.isErpAuthenticated, headerAuth.requireErpModuleAccess('product'), (req, res, next) => {
...
partnerProductRouter.get("/get", headerAuth.isErpAuthenticated, headerAuth.requireErpModuleAccess('product'), (req, res, next) => {
...
partnerProductRouter.get("/metrics", headerAuth.isErpAuthenticated, headerAuth.requireErpModuleAccess('product'), (req, res, next) => {
...
partnerProductRouter.post("/add", headerAuth.isErpAuthenticated, headerAuth.requireErpModuleAccess('product'), upload.single('product'), (req, res, next) => {
...
partnerProductRouter.post("/update", headerAuth.isErpAuthenticated, headerAuth.requireErpModuleAccess('product'), upload.single('product'), (req, res, next) => {
  if (req.fileValidationError) {
    return res.status(400).json({ success: false, message: "Invalid file type", data: {} });
  }
...
partnerProductRouter.patch("/update", headerAuth.isErpAuthenticated, headerAuth.requireErpModuleAccess('product'), upload.single('product'), (req, res, next) => {
  if (req.fileValidationError) {
    return res.status(400).json({ success: false, message: "Invalid file type", data: {} });
  }
...
partnerProductRouter.delete("/delete", headerAuth.isErpAuthenticated, headerAuth.requireErpModuleAccess('product'), (req, res, next) => {
  const data = {
    partner_id: res.locals.auth.partnerId || res.locals.auth.id,
