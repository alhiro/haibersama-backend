...
exports.getHistoriesGroupByEventDateAdmin = async function(req, res, next) {
  console.log("controller service");  
  ...
  try {
    ...
    var services = await ser.getHistoriesGroupByEventDateAdmin(req);
    return res
      .status(200)
      .json({ status: 200, data: services, message: "Riwayat Transaksi Berdasarkan Group Event Date Berhasil Diambil" });
  } catch (err) {
...
exports.getbalanceAdmin = async function(req, res, next) {
  console.log("controller service admin");  
  try {
    var services = await ser.getBalanceAdmin(req);
    return res
      .status(200)
      .json({ status: 200, data: services, message: "Riwayat Saldo Berhasil Diambil" });
  } catch (err) {
